...
if __name__ == "__main__":
    ...
    parser_f1.add_argument("-q_mol", "--query_file", help="The path of the input file that contains query compounds to be performed with PAINS filter", type=argparse.FileType('r'), dest= "infile", required=True)
    parser_f1.add_argument("-out", "--output_file", help="The path of the output file that contains result of Non-PAINS compounds", type=argparse.FileType('w'), dest= "outfile", required=True)
